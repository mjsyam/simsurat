    ...
    <div class="modal-dialog modal-dialog-centered mw-650px">
        <div class="modal-content">
            ...
            <div class="modal-body mx-5 mx-lg-15 mb-7">
                <form id="add_unit_modal_form" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                    <div class=" me-n10 pe-10" data-kt-scroll-max-height="auto" data-kt-scroll-offset="300px">
                        <div class="row mb-9">
                            ...
                            <div class="col-lg-12 mb-3">
                                <label class="d-flex align-items-center fs-6 form-label mb-2">
                                    <span class="fw-bold">Induk</span>
                                </label>
                                <select class="drop-data form-select form-select-solid" style="width: 100% !important;" name="parent_id">
                                    <option value=""></option>
